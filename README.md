...
## خطوات التشغيل
1. ارفع **`app.js` + `style.css` + `prompts.json` + `config.json`** إلى مستودع `Metaplus10` (فرع `main`).
2. الصق `يمين.txt` و `شمال.txt` في Perchance.
3. افتح المولّد — يحمّل CSS/JS/البيانات من GitHub تلقائيًا.

## روابط jsDelivr المستخدمة
```
https://cdn.jsdelivr.net/gh/cazanova971/Metaplus10@main/style.css
https://cdn.jsdelivr.net/gh/cazanova971/Metaplus10@main/app.js
https://cdn.jsdelivr.net/gh/cazanova971/Metaplus10@main/prompts.json
https://cdn.jsdelivr.net/gh/cazanova971/Metaplus10@main/config.json
```

## التعديل لاحقًا (بدون لمس Perchance)
عدّل أي ملف على GitHub → ادفع (push) → **فرّغ كاش jsDelivr** → أعد فتح الموقع:
```
https://purge.jsdelivr.net/gh/cazanova971/Metaplus10@main/app.js
https://purge.jsdelivr.net/gh/cazanova971/Metaplus10@main/style.css
https://purge.jsdelivr.net/gh/cazanova971/Metaplus10@main/prompts.json
https://purge.jsdelivr.net/gh/cazanova971/Metaplus10@main/config.json
```
